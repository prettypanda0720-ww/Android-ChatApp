...
/*
this library is made by @CJT2325 https://github.com/CJT2325/CameraView
i only modified it to fit my needs like adding chronometer and change save path
and disable rotate
 */
public class JCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSrc = a.getResourceId(R.styleable.JCameraView_iconSrc, R.drawable.ic_switch_camera);
    ...
    private void initView() {
        ...
        chronometerLayout = (LinearLayout) findViewById(R.id.chronometer_layout);
        chronometerIcon = (ImageView) findViewById(R.id.chronometer_icon);
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureListener() {
            ...
            public void takePictures() {
                ...
                if (isPickImageButtonEnabled)
                    pickImage.setVisibility(INVISIBLE);
                machine.capture();
            }
            ...
            public void recordStart() {
                ...
                chronometerLayout.setVisibility(VISIBLE);
                chronometer.setBase(SystemClock.elapsedRealtime());
                chronometer.start();
                animateChronometerIcon();
            }

            @Override
            public void recordShort(final long time) {
                mCaptureLayout.setTextWithAnimation("Time is too Short");
                mSwitchCamera.setVisibility(VISIBLE);
                mFlashLamp.setVisibility(VISIBLE);
                if (isPickImageButtonEnabled)
                    pickImage.setVisibility(VISIBLE);
                chronometerLayout.setVisibility(GONE);
                stopChronometer();
        ...
        pickImage.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (pickImageClickListener != null)
                    pickImageClickListener.onClick();
            }
        });
    }
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    private void animateChronometerIcon() {
        ...
        alphaAnimation1.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation arg0) {
                chronometerIcon.startAnimation(alphaAnimation2);
            }
        ...
        alphaAnimation2.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation arg0) {
                ...
                chronometerIcon.startAnimation(alphaAnimation1);
            }
    ...
    private void clearAlphaAnimation() {
        if (alphaAnimation1 == null || alphaAnimation2 == null)
            return;
        ...
        chronometerIcon.clearAnimation();
    }
